...
app = FastAPI(title="Player Line Predictor V2.4.1")
...
async def api_predict(payload: PredictPayload):
    ...
    if df.empty:
        raise HTTPException(status_code=404, detail="No cached data for this player, and auto-sync could not load any games.")
